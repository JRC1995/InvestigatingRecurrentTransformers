...
class optimizer_config:
    def __init__(self):
        ...
        self.eps = 1e-9
        self.betas = (0.9, 0.98)
        self.warmup_steps = (TRAIN_EXAMPLES // self.batch_size) * 1
        self.training_steps = (TRAIN_EXAMPLES // self.batch_size) * NUM_EPOCHS
...
class TLB_config(base_config):
    def __init__(self):
        ...
        self.ffn_dim = 128
        self.layers = 1
        self.model_chunk_size = 32
        self.update_layers = 1
        self.memory_size = 5
        self.lr = 1e-3
        self.global_position_encoding = False
        self.block = "TLBBlock"
