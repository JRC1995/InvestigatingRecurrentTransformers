...
def load_temp_checkpoint(agent, time, checkpoint_paths, args, log_paths):
    ...
    if args.load_checkpoint:
        ...
        if agent.epoch_scheduler is not None:
            agent.epoch_scheduler.load_state_dict(checkpoint['epoch_scheduler_state_dict'])
...
def save_temp_checkpoint(agent, checkpoint_paths, loaded_stuff, log_paths):
    ...
    if agent.epoch_scheduler is not None:
        loaded_stuff['epoch_scheduler_state_dict'] = agent.epoch_scheduler.state_dict()
